...
export class AppComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'firstName', 'lastName', 'email', 'gender', 'dob', 'education', 'company', 'experience', 'package', 'action'];
  ...
  openAddEditEmpForm() {
    const dialogRef = this._dialog.open(EmpManageComponent);
